    ...
    try {
      ...
      reader.onload = (e) => {
        image.onload = () => {
          ...
          // switch below). On native `jsQR` is `null` — jsqr is not bundled
          // there (TASK-210) — so the optional call yields `undefined` and
          // falls through to the "no QR code found" branch rather than
          // throwing.
          const code = jsQR?.(
            imageData.data,
            imageData.width,
